...
export const Template = (args) => html`
    <ul class="puds-menubar puds-menubar--shown" role="list">
...
* Change the arrow from a background style to an icon to allow it to be more easily styled using standard color references
