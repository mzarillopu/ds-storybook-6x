...
export const TextInputTemplate = (args) => html`
    <input class="puds-input" id="my-input" type="text" placeholder="Placeholder" value="${ args.value }" aria-label="My Input 1" />
    <input class="puds-input puds-focus" id="my-input2" type="text" placeholder="Placeholder" value="${ args.value }" aria-label="My Input 2" />
    <input class="puds-input puds-input--error" id="my-input3" type="text" placeholder="Placeholder" value="${ args.value }" aria-label="My Input 3" />
    <input class="puds-input" id="my-input4" type="text" placeholder="Placeholder" required value="${ args.value }" aria-label="My Input 4" />
`;

export const MultilineTextInputTemplate = (args) => html`
    <textarea class="puds-input" id="my-input" type="text" aria-label="My Input">${ args.value }</textarea>
    <textarea class="puds-input puds-focus" id="my-input2" type="text" aria-label="My Input 2">${ args.value }</textarea>
    <textarea class="puds-input puds-input--error" id="my-input3" type="text" aria-label="My Input 3">${ args.value }</textarea>
    <textarea class="puds-input" id="my-input4" type="text" aria-label="My Input 4" required>${ args.value }</textarea>
`;
