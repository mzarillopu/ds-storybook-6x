...
export const Template = (args) => html`
    ...
    <div class="emc-form-field--error">
        ...
        <span class="emc-form-field-error-msg" id="my-input3-msg" role="alert">Clear and brief error message</span>
        <input class="emc-input emc-input--error" id="my-input3" type="text" placeholder="Placeholder" value="${ args.value }" aria-describedby="my-input3-msg" />
    </div>
    <div class="emc-form-field">
        <label for="my-input4">${ args.label } - With Hint</label>
        <span class="emc-form-field-msg" id="my-input4-msg">Provide a helpful hint about the field</span>
        <input class="emc-input" id="my-input4" type="text" placeholder="Placeholder" required value="${ args.value }" aria-describedby="my-input4-msg" />
    </div>
    <div class="emc-form-field">
        <label for="my-input5">${ args.label }<span class="emc-form-field-required" aria-hidden="true">*</span></label>
        <input class="emc-input" id="my-input5" type="text" placeholder="Placeholder" required value="${ args.value }" required />
    </div>
`;
